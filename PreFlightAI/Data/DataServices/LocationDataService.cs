...
namespace PreFlightAI.Server.Services
{
    public class LocationDataService : ILocationDataService
    {
        ...
        public async Task<IEnumerable<Location>> GetLocationsByEmployeeId(int employeeId)
        {
            return await JsonSerializer.DeserializeAsync<IEnumerable<Location>>
                (await _clientLocation.GetStreamAsync($"api/location/{employeeId}"), new JsonSerializerOptions() { PropertyNameCaseInsensitive = true });
        }
